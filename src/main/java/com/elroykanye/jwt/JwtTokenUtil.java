...
public class JwtTokenUtil implements Serializable {
    ...
    public JwtTokenUtil(long jwtTokenValidity){
        tokenValidity = jwtTokenValidity;
    }

    public JwtTokenUtil(long jwtTokenValidity, SignatureAlgorithm signatureAlgorithm) {
        tokenValidity = jwtTokenValidity;
        algorithm = signatureAlgorithm;
    }

    public JwtTokenUtil(long jwtTokenValidity, SignatureAlgorithm signatureAlgorithm, String jwtSecret) {
        tokenValidity = jwtTokenValidity;
        algorithm = signatureAlgorithm;
        secret = jwtSecret;
    }

    public JwtTokenUtil(long jwtTokenValidity, SignatureAlgorithm signatureAlgorithm, String jwtSecret, String jwtTokenPrefix) {
        tokenValidity = jwtTokenValidity;
        algorithm = signatureAlgorithm;
        secret = jwtSecret;
    ...
    public JwtTokenUtil(long jwtTokenValidity, SignatureAlgorithm signatureAlgorithm, String jwtSecret, String jwtTokenPrefix, String jwtHeaderString) {
        tokenValidity = jwtTokenValidity;
        algorithm = signatureAlgorithm;
        secret = jwtSecret;
        tokenPrefix = jwtTokenPrefix;
